...
describe('Get /todo:id', () => {
    ...
    it('dhould return 404 if todo non object id', (done) => {
        ///todos/123
        request(app)
            .get("/todos/123abc")
            .set('x-auth', users[0].tokens[0].token)
...
describe('Get /users/me', () => {
    it('should return user if authentidated', (done) => {
        request(app)
            .get('/users/me')
            .set('x-auth', users[0].tokens[0].token)
            .expect(200)
    ...
    describe('Post /users', () => {
        it('should create a user', (done) => {
            var email = 'exampleawee@example.com';
            var password = '123mnb!';
            request(app)
                .post('/users')
                .send({ email, password })
...
describe('Delete /users/me/token', () => {
    it('it should remove auth token on loutout', (done) => {
        request(app)
